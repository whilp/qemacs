...
- **~9,300 lines deleted** across all changes
- **13 dead files removed** (configure, win32.c, x11.c, haiku.cpp, cfb.c/h, fbfrender.c/h, libfbf.c/h, html2png.c, modes/video.c, modes/image.c)
- **8 new tests added** (test_unix.c, test_cosmo.c)
- **No configure step** — config.h generated by Makefile
